...
public class PropertiesProvider extends QuickAccessProvider {
		...
		if (idToElement == null) {
			...
			if (activePage != null) {
				...
				if (selection instanceof IStructuredSelection && !selection.isEmpty()) {
					...
					List<IPreferenceNode> elements = pageManager.getElements(PreferenceManager.PRE_ORDER);
					for (IPreferenceNode property : elements) {
	...
	public String getName() {
		return QuickAccessMessages.get().QuickAccess_Properties;
	}
