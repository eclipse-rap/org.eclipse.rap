...
public class UIEvents {
	 ...
	 * @since 1.1
	 */
	public static final String REQUEST_ENABLEMENT_UPDATE_TOPIC = UIRendererTopicBase + "/requestEnablementUpdate"; //$NON-NLS-1$
	...
	/**
	 * E4 UI Event Types. Add appropriate utility is<Test> method below if new
	 * types added
	 */
	public static interface EventTypes {
		 ...
		 * {@link EventTags#OLD_VALUE} (a collection). The former positions of
		 * the removed values are provided as an integer array in
		...
		/**
		 * Value moved: the value moved is the {@link EventTags#NEW_VALUE}, the
		 * old position is {@link EventTags#OLD_VALUE}, and the new position in
		 * {@link EventTags#POSITION}.
		 */
	...
	public static boolean isREMOVE(Event event) {
		Object type = event.getProperty(UIEvents.EventTags.TYPE);
		return UIEvents.EventTypes.REMOVE.equals(type) || UIEvents.EventTypes.REMOVE_MANY.equals(type);
	}
	...
	/**
	 * Return true if the specified property contains {@code o}. Intended as a
	 * helper function for {@link EventTypes#ADD}, {@link EventTypes#ADD_MANY},
	 * {@link EventTypes#REMOVE}, and {@link EventTypes#REMOVE_MANY}. If the
	 * property is not a container (e.g., a collection or array), then return
	 * true then if {@code container} is equal to {@code o}.
	 *
	 * @param event
	 *            the event
	 * @param propertyName
	 ...
	 * @return true if the property value contains {@code o} or is equal to
	 *         {@code o}
	 */
	...
	/**
	 * Return the provided event property as an iterable. If already a
	...
	/**
	 * E4 UI life cycle events. These events are explicitly published by
	 * specific operations. They are not directly generated by UI model changes.
	 */
	public static interface UILifeCycle {
		 ...
		 * @since 1.1
		 */
		public static final String THEME_DEFINITION_CHANGED = TOPIC + TOPIC_SEP + "themeDefinitionChanged"; //$NON-NLS-1$
	}

	/**
	 * Publish the topic to the changedElements global event bus. The
	 * changedElement is added the the EventTags.ELEMENT tag.
	 *
	 * @param topic
	 *            to broadcast
	...
	/**
	 * Publish the topic with the provided arguments to the global event bus.
	 * argMap MUST contain an EventTags.ELEMENT argument that is an MUIElement.
	 * the contained MUIElement will be used to determine the event bus to
	 * publish to.
	 *
	 * @param topic
	 *            to broadcast
	...
	public static boolean publishEvent(String topic, Map<String, Object> argMap) {
		...
		IEclipseContext context = uiElement instanceof MApplication ? ((MApplication) uiElement).getContext()
				: ModelUtils.getContainingContext((MUIElement) uiElement);
		if (context == null)
			return false;
	...
	@Deprecated
	/**
	 * @deprecated Subscribe to an all attribute events on a topic using the
	 *             TOPIC_ALL constant directly
	 */
	...
	@Deprecated
	/**
	 * @deprecated Subscribe to an attribute event by using the
	 *             TOPIC_<attribute> constant directly
	 */
	...
	@Deprecated
	/**
	 * @deprecated Subscribing to a particular event type on a topic attribute
	 ...
	 *
	 * Replace the generated code below this comment with the output of
	 * GenTopic.
	 *
	 *************************************************************************************/
