...
rwt.protocol.AdapterRegistry.add( "rwt.widgets.Grid", {
  ...
  propertyHandler : rwt.protocol.AdapterUtil.extendControlPropertyHandler( {
    ...
    "selection" : function( widget, value ) {
      ...
      for( var i = 0; i < value.length; i++ ) {
        rwt.protocol.AdapterUtil.callWithTarget( value[ i ], applySelection );
      }
    },
    "sortColumn" : function( widget, value ) {
      rwt.protocol.AdapterUtil.callWithTarget( value, function( column ) {
