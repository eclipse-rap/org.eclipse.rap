...
rwt.protocol.HandlerRegistry.add( "rwt.widgets.MenuItem", {

  factory : function( properties ) {
    var result;
    rwt.protocol.HandlerUtil.callWithTarget( properties.parent, function( menu ) {
      ...
      rwt.protocol.HandlerUtil.addDestroyableChild( menu, result );
  ...
  listenerHandler : {
    ...
    "Help" : rwt.protocol.HandlerUtil.getControlListenerHandler( "Help" )
  }
