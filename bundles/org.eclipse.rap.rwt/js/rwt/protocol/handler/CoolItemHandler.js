...
rwt.protocol.HandlerRegistry.add( "rwt.widgets.CoolItem", {

  factory : function( properties ) {
    var styles = rwt.protocol.HandlerUtil.createStyleMap( properties.style );
  ...
  propertyHandler : {
    ...
    "control" : function( widget, controlId ) {
      rwt.protocol.HandlerUtil.callWithTarget( controlId, function( control ) {
