...
rwt.protocol.HandlerRegistry.add( "rwt.widgets.GridColumn", {
  ...
  destructor : function( column ) {
    rwt.protocol.HandlerUtil.removeDestroyableChild( column._grid, column );
    column.dispose();
  },
  ...
  propertyHandler : {
    ...
    "group" : function( widget, value ) {
      rwt.protocol.HandlerUtil.callWithTarget( value, function( group ) {
