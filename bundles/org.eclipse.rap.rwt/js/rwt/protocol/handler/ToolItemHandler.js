...
rwt.protocol.HandlerRegistry.add( "rwt.widgets.ToolItem", {
  ...
  factory : function( properties ) {
    ...
    var result;
    rwt.protocol.HandlerUtil.callWithTarget( properties.parent, function( toolbar ) {
      if( type === "separator" ) {
      ...
      rwt.protocol.HandlerUtil.addDestroyableChild( toolbar, result );
  ...
  propertyHandler : {
    "bounds" : rwt.protocol.HandlerUtil.getControlPropertyHandler( "bounds" ),
