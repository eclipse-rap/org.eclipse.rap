...
rwt.protocol.HandlerRegistry.add( "rwt.widgets.Shell", {

  factory : function( properties ) {
    var adapterUtil = rwt.protocol.HandlerUtil;
  ...
  propertyHandler : rwt.protocol.HandlerUtil.extendControlPropertyHandler( {
    ...
    "defaultButton" : function( shell, value ) {
      rwt.protocol.HandlerUtil.callWithTarget( value, function( widget ) {
