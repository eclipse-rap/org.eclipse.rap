...
rwt.protocol.HandlerUtil = {

  _controlDestructor : function( widget ) {
    rwt.protocol.HandlerUtil._widgetDestructor( widget );
  },

  _childrenFinder : function( widget ) {
    return rwt.protocol.HandlerUtil.getDestroyableChildren( widget );
  },
  ...
  _controlPropertyHandler : {
    "children" : function( widget, value ) {
      if( value !== null ) {
        ...
        for( var i = 0; i < childrenCount; i++ ) {
          rwt.protocol.HandlerUtil.callWithTarget( value[ i ], applyZIndex );
        }
      }
    },
    ...
    "menu" : function( widget, value ) {
      rwt.protocol.HandlerUtil.callWithTarget( value, function( menu ) {
  ...
  _setParentImplementation : function( widget, parent ) {
    ...
    rwt.protocol.HandlerUtil.addDestroyableChild( parent, widget );
