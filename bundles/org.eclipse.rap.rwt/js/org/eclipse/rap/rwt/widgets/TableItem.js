 ...
 * org.eclipse.rap.rwt.TableItem.
 */
qx.OO.defineClass(
  "org.eclipse.rap.rwt.widgets.TableItem",
  qx.core.Target,
...
qx.Proto.dispose = function() {
  ...
  org.eclipse.rap.rwt.WidgetManager.getInstance().remove( this );
...
qx.Proto._getMarkup = function() {
  ...
  for( var i = 0; i < this.getTable().getColumnCount(); i++ ) {
    ...
    var cellMarkup
      = org.eclipse.rap.rwt.widgets.TableItem.DIV_START_OPEN
      + "style=\""
      + org.eclipse.rap.rwt.widgets.TableItem.CONST_STYLE
      + this._borderMarkup()
      + "left:" + left + org.eclipse.rap.rwt.widgets.TableItem.PX
      + "width:" + width + org.eclipse.rap.rwt.widgets.TableItem.PX
      + "\""
      + org.eclipse.rap.rwt.widgets.TableItem.DIV_START_CLOSE
      + text
      + org.eclipse.rap.rwt.widgets.TableItem.DIV_END;
...
qx.Proto._borderMarkup = function() {
  ...
  if( this.getTable().getLinesVisible() ) {
    result = org.eclipse.rap.rwt.widgets.TableItem.LINE_BORDER;
  }
  return result;
}
