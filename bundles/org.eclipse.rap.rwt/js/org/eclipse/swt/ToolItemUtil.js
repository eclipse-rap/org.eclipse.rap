 ...
 */
qx.OO.defineClass( "org.eclipse.swt.ToolItemUtil" );
...
qx.Class.createDropDown = function( id, parent, isFlat ) {
  ...
  var button = org.eclipse.swt.WidgetManager.getInstance().findWidgetById( id );
  ...
  org.eclipse.swt.WidgetManager.getInstance().add( dropDown, 
                                                       dropDownId, 
                                                       false );
...
org.eclipse.swt.ToolItemUtil._onDropDownChangeEnabled = function( evt ) {
  var widgetManager = org.eclipse.swt.WidgetManager.getInstance();
...
qx.Class._dropDownSelected = function( evt ) { 
  ...
  org.eclipse.swt.EventUtil.doWidgetSelected( dropDownId, 
                                                  left, 
                                                  top, 
                                                  0,
                                                  0 );
