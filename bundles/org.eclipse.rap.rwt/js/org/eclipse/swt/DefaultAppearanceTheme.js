...
qx.OO.defineClass(
  "org.eclipse.swt.DefaultAppearanceTheme", 
...
qx.Proto._appearances = qx.lang.Object.carefullyMergeWith( {
  ...
  "label" : {
    setup : function() {
      this.font = new qx.renderer.font.Font( 11, org.eclipse.swt.DefaultAppearanceTheme.systemFontName );
  ...
  "window-captionbar" : {
    setup : function() {
      this.bgimage_active = "./org/eclipse/swt/widgets/shell/caption_active.gif";
      this.bgimage_inactive = "./org/eclipse/swt/widgets/shell/caption_inactive.gif";
  ...
  // appearance for org.eclipse.swt.widgets.Label with style RWT.SEPARATOR
  "separator" : {
    setup: function() {
      this.border_default = qx.renderer.border.BorderPresets.getInstance().none;
      this.border = qx.renderer.border.BorderPresets.getInstance().thinInset;
