...
qx.OO.defineClass( "org.eclipse.swt.TextUtil" );
 ...
 */
org.eclipse.swt.TextUtil.modifyText = function( evt ) {
 ...
 */
org.eclipse.swt.TextUtil.modifyTextAction = function( evt ) {
  var text = evt.getTarget();
  if(    !org_eclipse_rap_rwt_EventUtil_suspend 
 ...
 * was a server-side ModifyListener registered.
 */
org.eclipse.swt.TextUtil.modifyTextOnBlur = function( evt ) {
  if(    !org_eclipse_rap_rwt_EventUtil_suspend 
...
org.eclipse.swt.TextUtil._onSend = function( evt ) {
...
org.eclipse.swt.TextUtil._delayedModifyText = function( evt ) {
...
org.eclipse.swt.TextUtil._isModified = function( widget ) {
  return widget.getUserData( "modified" ) == true;
}

org.eclipse.swt.TextUtil._setModified = function( widget, modified ) {
 ...
 */
org.eclipse.swt.TextUtil._isModifyingKey = function( keyIdentifier ) {
  var result = false;
...
org.eclipse.swt.TextUtil.onMouseUp = function( evt ) {
  if( !org_eclipse_rap_rwt_EventUtil_suspend ) {
    org.eclipse.swt.TextUtil.updateSelection( evt.getTarget() );
  }
}

org.eclipse.swt.TextUtil.updateSelection = function( text ) {
...
org.eclipse.swt.TextUtil._setPropertyParam = function( widget, name, value ) {
  var widgetManager = org.eclipse.swt.WidgetManager.getInstance();
...
org.eclipse.swt.TextUtil.setSelection = function( text, start, length ) {
  if( text.isCreated() ) {
...
org.eclipse.swt.TextUtil._onAppearSetSelection = function( evt ) {
  var text = evt.getTarget();  
...
org.eclipse.swt.TextUtil._doSetSelection = function( text, start, length ) {
  text.setUserData( "selectionStart", start );
