...
public class ViewForm extends Composite {
  ...
  // static final int BORDER1_COLOR = RWT.COLOR_WIDGET_NORMAL_SHADOW;
  // static final int SELECTION_BACKGROUND = RWT.COLOR_LIST_BACKGROUND;
  /**
  ...
  public ViewForm( Composite parent, int style ) {
    ...
    setBorderVisible( ( style & RWT.BORDER ) != 0 );
    ...
    // };
    //
    // int[] events = new int[] {RWT.Dispose, SWT.Paint, SWT.Resize};
    //
   ...
   * getDisplay().getSystemColor(RWT.COLOR_LIST_SELECTION);
