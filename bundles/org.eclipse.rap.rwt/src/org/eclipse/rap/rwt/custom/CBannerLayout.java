...
class CBannerLayout extends Layout {
                               ...
                               boolean flushCache )
  {
    ...
    if( right != null ) {
      ...
      int w = RWT.DEFAULT;
      if( banner.rightWidth != RWT.DEFAULT ) {
      ...
      rightSize = computeChildSize( right, w, RWT.DEFAULT, flushCache );
    ...
    if( left != null ) {
      ...
      int w = wHint == RWT.DEFAULT
                                  ? RWT.DEFAULT
                                  : Math.max( 0, width - trim );
      leftSize = computeChildSize( left, w, RWT.DEFAULT, flushCache );
    }
    // Add up sizes
    ...
    if( left != null ) {
      if( right == null ) {
        ...
        height += Math.max( leftSize.y,
                            banner.rightMinHeight == RWT.DEFAULT
                                                                ? rightSize.y
