...
public final class GridData {
	 ...
	 */
	public int widthHint = RWT.DEFAULT;
	 ...
	 * @see Control#computeSize(int, int, boolean)
	 */
	public int heightHint = RWT.DEFAULT;
	 ...
	 */
	public static final int BEGINNING = RWT.BEGINNING;
	 ...
	 */
	public static final int FILL = RWT.FILL;
...
public String toString () {
	...
	switch (horizontalAlignment) {
		case RWT.FILL: hAlign = "SWT.FILL"; break;
		case RWT.BEGINNING: hAlign = "SWT.BEGINNING"; break;
		case RWT.LEFT: hAlign = "SWT.LEFT"; break;
		case RWT.END: hAlign = "SWT.END"; break;
		case END: hAlign = "GridData.END"; break;
		case RWT.RIGHT: hAlign = "SWT.RIGHT"; break;
		case RWT.CENTER: hAlign = "SWT.CENTER"; break;
		case CENTER: hAlign = "GridData.CENTER"; break;
		default: hAlign = "Undefined "+horizontalAlignment; break;
	}
	String vAlign = "";
	switch (verticalAlignment) {
		case RWT.FILL: vAlign = "SWT.FILL"; break;
		case RWT.BEGINNING: vAlign = "SWT.BEGINNING"; break;
		case RWT.TOP: vAlign = "SWT.TOP"; break;
		case RWT.END: vAlign = "SWT.END"; break;
		case END: vAlign = "GridData.END"; break;
		case RWT.BOTTOM: vAlign = "SWT.BOTTOM"; break;
		case RWT.CENTER: vAlign = "SWT.CENTER"; break;
 	...
 	if (widthHint != RWT.DEFAULT) string += "widthHint="+widthHint+" ";
	...
	if (verticalSpan != 1) string += "verticalSpan="+verticalSpan+" ";
 	...
 	if (heightHint != RWT.DEFAULT) string += "heightHint="+heightHint+" ";
