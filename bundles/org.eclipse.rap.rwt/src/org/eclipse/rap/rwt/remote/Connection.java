...
/**
 * An instance of this interface represents a connection used to communicate with the remote client.
 * Every UI session has exactly one connection which can be obtained by calling
...
public interface Connection {
   ...
   *
   * @param remoteType the type of the remote object to be created
