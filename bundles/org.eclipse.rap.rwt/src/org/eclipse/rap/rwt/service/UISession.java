...
/**
 * The <code>UISession</code> represents a storage place for objects
...
public interface UISession extends ISessionStore {
   ...
   * <code>UISession</code>, or <code>null</code> if no object is bound
   * under the name.
   *
   ...
   * <code>UISession</code>. If no object is bound with the specified name,
   ...
   *             <code>UISession</code>; cannot be null
   ...
   *         <code>UISession</code> or an empty enumeration if the
   *         underlying session was invalidated.
   * @see #isBound()
   */
  ...
  /**
   * Adds an instance of <code>UISessionListener</code> to this
   * <code>UISession</code>. <code>UISessionListener</code>s are
   ...
   *
   * @param listener the UISessionListener to be added
  ...
  /**
   * Removes an instance of <code>UISessionListener</code> to this
   * <code>UISession</code>. <code>UISessionListener</code>s are
   * used to get notifications before the session store is destroyed.
   * If the given listener is not added to the session store this method
   * has no effect.
   *
   * @param listener the UISessionListener to be removed
  ...
  /**
   * Returns whether this <code>UISession</code> is bound to the
