 ...
 * messages to controls asking for information about the control instance.
 * <p>
...
public class AccessibleEvent extends SWTEventObject {
  ...
  /**
   * The value of this field is set by an accessibility client before the
   * accessible listener method is called. ChildID can be CHILDID_SELF,
   * representing the control itself, or a 0-based integer representing a
   * specific child of the control.
   */
  public int childID;

  /**
   * The value of this field must be set in the accessible listener method
   * before returning. What to set it to depends on the listener method called,
   * and the childID specified by the client.
   */
