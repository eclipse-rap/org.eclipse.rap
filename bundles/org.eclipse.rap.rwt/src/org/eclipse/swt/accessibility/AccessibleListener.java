 ...
 * events that are generated when an accessibility client sends a message to a
 * control.
 * <p>
 * After creating an instance of a class that implements this interface it can
 * be added to a control using the <code>addAccessibleListener</code> method and
 * removed using the <code>removeAccessibleListener</code> method. When a client
 * requests information, the appropriate method will be invoked.
 * </p>
 * <p>
...
public interface AccessibleListener extends SWTEventListener {
   ...
   *          <ul>
   *          <li>childID [IN] - an identifier specifying the control or one of
   *          its children</li>
  ...
  /**
   * Sent when an accessibility client requests the help string of the control,
   * or the help string of a child of the control.
   * <p>
   * The information in this property should be similar to the help provided by
   * toolTipText. It describes what the control or child does or how to use it,
   * as opposed to getDescription, which describes appearance.
   * </p>
   * <p>
   ...
   * control, or the keyboard shortcut of a child of the control.
   * <p>
   * A keyboard shortcut can either be a mnemonic, or an accelerator. As a
   * general rule, if the control or child can receive keyboard focus, then you
   * should expose its mnemonic, and if it cannot receive keyboard focus, then
   * you should expose its accelerator.
   * </p>
   * <p>
  ...
  /**
   * Sent when an accessibility client requests a description of the control, or
   * a description of a child of the control.
   * <p>
   * This is a textual description of the control or child's visual appearance,
   * which is typically only necessary if it cannot be determined from other
   * properties such as role.
   * </p>
   * <p>
