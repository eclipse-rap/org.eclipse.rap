...
public class ControlDecoratorLCA extends AbstractWidgetLCA {
  ...
  public void preserveValues( Widget widget ) {
    ...
    adapter.preserve( PROP_VISIBLE, Boolean.valueOf( decorator.isVisible() ) );
    Boolean hasListener = Boolean.valueOf( SelectionEvent.hasListener( decorator ) );
  ...
  private static void processSelectionEvent( ControlDecorator decorator, int id ) {
    ...
    SelectionEvent event
      = new SelectionEvent( decorator, null, id, bounds, stateMask, "", true, SWT.NONE );
    event.processEvent();
  }
}
