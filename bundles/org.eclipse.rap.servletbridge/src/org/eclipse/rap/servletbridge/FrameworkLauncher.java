/*******************************************************************************
 * Copyright (c) 2005, 2026 Cognos Incorporated, IBM Corporation and others.
 *
...
public class FrameworkLauncher {
	...
	private static final String EXTENSIONBUNDLE_DEFAULT_VERSION = "4.7.0"; //$NON-NLS-1$
	...
	private void generateExtensionBundle(File plugins, String extensionBundleBSN, String extensionBundleVersion) {
		...
		if (context.getMajorVersion() >= 6) {
			packageExports = "org.eclipse.rap.servletbridge; version=4.7" + //$NON-NLS-1$
