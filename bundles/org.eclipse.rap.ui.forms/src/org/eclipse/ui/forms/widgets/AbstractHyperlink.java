...
// RAP [rh] unnucessary code: was used by MouseUp/MouseDown listeners
//	/*
...
//	private boolean armed;
	...
	public AbstractHyperlink(Composite parent, int style) {
		super(parent, style);
// RAP [rh] missing key, paint and traverse events
...
//					handleExit(e);
//					break;
// RAP [rh] mouse-up- and -down unnecessary, see DefaultSelection
//				case SWT.MouseDown:
//					handleMouseDown(e);
//					break;
//				case SWT.MouseUp:
...
// RAP [rh] Unused code: was used by MouseUp and MouseDown events
