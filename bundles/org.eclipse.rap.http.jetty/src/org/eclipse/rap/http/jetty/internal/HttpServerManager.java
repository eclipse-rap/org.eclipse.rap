...
import org.eclipse.rap.http.jetty.JettyConstants;
...
public class HttpServerManager implements ManagedServiceFactory {
	...
	public synchronized void updated(String pid, Dictionary<String, ?> dictionary) throws ConfigurationException {
		...
		holder.setInitParameter(Constants.SERVICE_DESCRIPTION, "RAP Jetty-based Http Service"); //$NON-NLS-1$

		String multipartServletName = "RAP Jetty-based Http Service - Multipart Servlet"; //$NON-NLS-1$
