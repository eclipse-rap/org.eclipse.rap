...
public class HttpRegistryManager {
	...
	class FilterContribution {
		...
		public FilterContribution(String alias, jakarta.servlet.Filter filter, Dictionary<?, ?> initparams,
	...
	public synchronized boolean addFilterContribution(String alias, jakarta.servlet.Filter filter,
