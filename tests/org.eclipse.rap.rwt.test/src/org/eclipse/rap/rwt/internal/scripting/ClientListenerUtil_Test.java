...
public class ClientListenerUtil_Test {
  ...
  public void testClientListenerAdded() {
    ...
    List<ClientListenerOperation> added = ClientListenerUtil.getClientListenerOperations( widget );
  ...
  public void testClientListenerRemoved() {
    ...
    List<ClientListenerOperation> removed = ClientListenerUtil.getClientListenerOperations( widget );
  ...
  @Test
  public void testClearClientListenerOperations() {
    ...
    assertNull( ClientListenerUtil.getClientListenerOperations( widget ) );
  }
