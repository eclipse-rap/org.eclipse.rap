...
public class MenuItemLCA_Test extends TestCase {
  ...
  public void testWidgetSelected() {
    ...
    Fixture.fakeNotifyOperation( getId( menuItem ), ClientMessageConst.EVENT_SELECTED, null );
  ...
  public void testRadioTypedSelectionEventOrder_TypedListener() {
    ...
    Fixture.fakeNotifyOperation( getId( radioItem1 ), EVENT_SELECTED, null );
    Fixture.fakeNotifyOperation( getId( radioItem2 ), EVENT_SELECTED, null );
