/*******************************************************************************
 * Copyright (c) 20011 EclipseSource and others. All rights reserved.
 ...
 qx.Class.define( "org.eclipse.rwt.test.tests.DateTimeDateTest", {
  ...
  members : {
    ...
    testSendAllFieldsTogether : function() {
      ...
      assertEquals(
        10,
        org.eclipse.swt.Request.getInstance()._parameters[ "w3.day" ]
      );
      assertEquals(
        10,
        org.eclipse.swt.Request.getInstance()._parameters[ "w3.month" ]
      );
      assertEquals(
        2010,
        org.eclipse.swt.Request.getInstance()._parameters[ "w3.year" ]
      );
    },
