...
public class ShellFancyTheme_Test extends TestCase {
  ...
  public void testShellTitleBarBackgroundImage() {
    ...
    assertEquals( "#a8dd32", gradienColors[ 0 ] );
    assertEquals( "#87b127", gradienColors[ 1 ] );
  }
  ...
  public void testShellTitleBorder() {
    ...
    assertEquals( "#99c92c", border.color );
  }
  ...
  public void testShellCloseButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-CloseButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-close.png", image.path );
  }
  ...
  public void testShellCloseButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-CloseButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-close-hover.png", image.path );
  }
  ...
  public void testShellMaxButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-MaxButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-max.png", image.path );
  }
  ...
  public void testShellMaxButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-MaxButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-max-hover.png", image.path );
  }
  ...
  public void testShellMinButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-MinButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-min.png", image.path );
  }
  ...
  public void testShellMinButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( shell, 
                                               ...
                                               "Shell-MinButton" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/shell-min-hover.png", image.path );
  }
