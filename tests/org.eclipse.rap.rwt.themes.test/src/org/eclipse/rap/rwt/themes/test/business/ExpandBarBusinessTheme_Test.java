...
public class ExpandBarBusinessTheme_Test extends TestCase {
  ...
  public void testExpandItemButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( bar, 
                                               ...
                                               "ExpandItem-Button");
    QxImage image = ( QxImage ) cssValue;   
    assertEquals( "theme/business/icons/expanditem-expand.png", image.path );
  }
  ...
  public void testExpandItemButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( bar, 
                                               ...
                                               "ExpandItem-Button");
    QxImage image = ( QxImage ) cssValue;   
    assertEquals( "theme/business/icons/expanditem-expand-hover.png", 
                  image.path );
  }
  ...
  public void testExpandItemButtonBackgroundImageExpanded() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( bar, 
                                               ...
                                               "ExpandItem-Button");
    QxImage image = ( QxImage ) cssValue;   
    assertEquals( "theme/business/icons/expanditem-collapse.png", 
                  image.path );
  }
  ...
  public void testExpandItemButtonBackgroundImageExpandedHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( bar, 
                                               ...
                                               "ExpandItem-Button");
    QxImage image = ( QxImage ) cssValue;   
    assertEquals( "theme/business/icons/expanditem-collapse-hover.png", 
                  image.path );
  }
