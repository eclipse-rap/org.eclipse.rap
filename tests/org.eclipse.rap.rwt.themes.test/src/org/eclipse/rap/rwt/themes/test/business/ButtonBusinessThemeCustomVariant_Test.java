...
public class ButtonBusinessThemeCustomVariant_Test extends TestCase {
  ...
  public void testViewCloseBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_active_close_active.png", 
                  image.path );
  }
  ...
  public void testViewCloseBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_active_close_active_hover.png", 
                  image.path );
  }
  ...
  public void testViewCloseInactiveBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_inactive_close_active.png", 
                  image.path );
  }
  ...
  public void testViewCloseInactiveBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_inactive_close_active_hover.png", 
                  image.path );
  }
  ...
  public void testToolbarOverflowInactiveBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/toolbar_overflow.png", image.path );
  }
  ...
  public void testToolbarOverflowInactiveBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/toolbar_overflow_hover.png", image.path );
  }
  ...
  public void testToolbarOverflowActiveBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/toolbar_overflow_active.png", image.path );
  }
  ...
  public void testToolbarOverflowActiveBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/toolbar_overflow_hover_active.png", 
                  image.path );
  }
  ...
  public void testTabOverflowActiveBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_overflow_active.png", image.path );
  }
  ...
  public void testTabOverflowActiveBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_overflow_active_hover.png", 
                  image.path );
  }
  ...
  public void testTabOverflowInactiveBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_overflow_inactive.png", image.path );
  }
  ...
  public void testTabOverflowInactiveBackgroundImageHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValue( button, 
                                                   ...
                                                   "background-image" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "img/business/stack_tab_overflow_inactive_hover.png", 
                  image.path );
  }
