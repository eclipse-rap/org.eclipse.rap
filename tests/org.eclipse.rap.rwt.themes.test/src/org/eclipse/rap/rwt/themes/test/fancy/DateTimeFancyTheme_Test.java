...
public class DateTimeFancyTheme_Test extends TestCase {
  ...
  public void testDateTimeCalendarPreviousMonthButtonBackgroundImage() {
    ...
    assertEquals( "theme/fancy/icons/lastMonth.png", image.path );
  }
  ...
  public void testDateTimeCalendarPreviousMonthButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/lastMonth-hover.png", image.path );
  }
  ...
  public void testDateTimeCalendarNextMonthButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/nextMonth.png", image.path );
  }
  ...
  public void testDateTimeCalendarNextMonthButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/nextMonth-hover.png", image.path );
  }
  ...
  public void testDateTimeCalendarPreviousYearButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/lastYear.png", image.path );
  }
  ...
  public void testDateTimeCalendarPreviousYearButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/lastYear-hover.png", image.path );
  }
  ...
  public void testDateTimeCalendarNextYearButtonBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/nextYear.png", image.path );
  }
  ...
  public void testDateTimeCalendarNextYearButtonBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/nextYear-hover.png", image.path );
  }
  ...
  public void testDateTimeUpButtonIconBackgroundImage() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/up.png", image.path );
  }
  ...
  public void testDateTimeUpButtonIconBackgroundImageHover() {
    ...
    QxType cssValue 
      = ThemesTestUtil.getCssValueForElement( time, 
                                               ...
                                               element );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/up-hover.png", image.path );
  }
