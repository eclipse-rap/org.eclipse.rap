...
public class ButtonBusinessTheme_Test extends TestCase {
  ...
  public void testBackgroundImageForCheckUnselected() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/check-unselected.png", qxImage.path );
  }
  ...
  public void testBackgroundImageForCheckSelected() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/check-selected.png", qxImage.path );
  }
  ...
  public void testBackgroundImageForCheckSelectedHover() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/check-selected-hover.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForCheckSelectedGrayed() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/check-grayed.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForCheckSelectedGrayedHover() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/check-grayed-hover.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForRadioUnselected() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/radio-unselected.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForRadioSelected() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/radio-selected.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForRadioUnselectedHover() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/radio-unselected-hover.png", 
                  qxImage.path );
  }
  ...
  public void testBackgroundImageForRadioSelectedHover() {
    ...
    QxImage qxImage = ( QxImage ) cssValue;
    assertEquals( "theme/business/icons/radio-selected-hover.png", 
                  qxImage.path );
  }
