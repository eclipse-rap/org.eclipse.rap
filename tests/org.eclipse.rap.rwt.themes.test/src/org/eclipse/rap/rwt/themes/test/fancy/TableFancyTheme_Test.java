...
public class TableFancyTheme_Test extends TestCase {
  ...
  public void testTableCheckboxBackgroundImage() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValueForElement( table, 
                                                             ...
                                                             "Table-Checkbox" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/check-unselected.png", image.path );
  }
  ...
  public void testTableCheckboxBackgroundImageChecked() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValueForElement( table, 
                                                             ...
                                                             "Table-Checkbox" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/check-selected.png", image.path );
  }
  ...
  public void testTableCheckboxBackgroundImageCheckedHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValueForElement( table, 
                                                             ...
                                                             "Table-Checkbox" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/check-selected-hover.png", image.path );
  }
  ...
  public void testTableCheckboxBackgroundImageCheckedGrayed() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValueForElement( table, 
                                                             ...
                                                             "Table-Checkbox" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/check-grayed.png", image.path );
  }
  ...
  public void testTableCheckboxBackgroundImageCheckedGrayedHover() {
    ...
    QxType cssValue = ThemesTestUtil.getCssValueForElement( table, 
                                                             ...
                                                             "Table-Checkbox" );
    QxImage image = ( QxImage ) cssValue;
    assertEquals( "theme/fancy/icons/check-grayed-hover.png", image.path );
  }
