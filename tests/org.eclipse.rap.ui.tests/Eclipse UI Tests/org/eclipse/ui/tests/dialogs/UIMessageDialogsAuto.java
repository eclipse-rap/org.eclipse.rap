...
//                WorkbenchMessages.FileEditorPreference_existsMessage);
        Dialog dialog = getInformationDialog(WorkbenchMessages.get().FileEditorPreference_existsTitle,
...
//        Dialog dialog = getInformationDialog(WorkbenchMessages.PropertyDialog_messageTitle, NLS.bind(WorkbenchMessages.PropertyDialog_noPropertyMessage, (new Object[] { "DummyPropertyPage" })));
        Dialog dialog = getInformationDialog(WorkbenchMessages.get().PropertyDialog_messageTitle, NLS.bind(WorkbenchMessages.get().PropertyDialog_noPropertyMessage, (new Object[] { "DummyPropertyPage" })));
        DialogCheck.assertDialogTexts(dialog, this);
    }
...
//        Dialog dialog = getInformationDialog(WorkbenchMessages.Information, "operationNotAvailableMessage");
        Dialog dialog = getInformationDialog(WorkbenchMessages.get().Information, "operationNotAvailableMessage");
        DialogCheck.assertDialogTexts(dialog, this);
    }
...
//                        IDialogConstants.NO_LABEL,
//                        IDialogConstants.CANCEL_LABEL }, 0);
        Dialog dialog = new MessageDialog(getShell(), WorkbenchMessages.get().Save_Resource, null, NLS.bind(WorkbenchMessages.get().EditorManager_saveChangesQuestion, (new Object[] { DUMMY_RESOURCE })), MessageDialog.QUESTION,
                new String[] { IDialogConstants.get().YES_LABEL,
                        IDialogConstants.get().NO_LABEL,
                        IDialogConstants.get().CANCEL_LABEL }, 0);
        DialogCheck.assertDialogTexts(dialog, this);
