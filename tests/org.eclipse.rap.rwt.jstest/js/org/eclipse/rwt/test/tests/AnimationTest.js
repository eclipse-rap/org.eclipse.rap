  ...
  members : {
   ...
   testSkip : function() {
    ...
    testGlow : function() {
      ...
      assertTrue( animation.isStarted() );
      assertEquals( [ 255, 0, 0 ], ColorUtil.stringToRgb( widget._style.backgroundColor ) );
      assertEquals( [ 255, 0, 0 ], ColorUtil.stringToRgb( renderer.getStartValue() ) );
      assertEquals( [ 0, 255, 0 ], ColorUtil.stringToRgb( renderer.getEndValue() ) );
      animation._render( 0.5 ); assertTrue( animation.isRunning() );
      assertEquals( [ 128, 128, 0 ], ColorUtil.stringToRgb( renderer.getLastValue() ) );
      assertEquals( [ 128, 128, 0 ], ColorUtil.stringToRgb( widget._style.backgroundColor ) );
      animation._finish();
      assertFalse( animation.isStarted() );
      assertEquals( [ 0, 255, 0 ], ColorUtil.stringToRgb( renderer.getLastValue() ) );
      assertEquals( [ 0, 255, 0 ], ColorUtil.stringToRgb( widget._style.backgroundColor ) );
      widget.hide();
      assertFalse( animation.isStarted() );
      this._cleanUp( animation );
    },
    ...
    testResize : function() {
      ...
      assertEquals( 250, parseInt( widget._style.height, 10 ) );
      animation._finish();
      assertEquals( 300, renderer.getLastValue() );
      assertEquals( 300, parseInt( widget._style.height, 10 ) );
      assertFalse( animation.isStarted() );
      widget.hide();
      assertFalse( animation.isStarted() );
      this._cleanUp( animation );
    ...
    testRenderCallDuringChangeAnimation : function() {
      ...
      assertEquals( 350, parseInt( widget._style.height, 10 ) );
      assertFalse( animation.isStarted() );
      this._cleanUp( animation );
    },
